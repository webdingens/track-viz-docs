...
Go to app that loads an example file: [app with example library](https://trackviz.netlify.app/?load_library=/data/example_library.json)

Download the [example library](https://trackviz.netlify.app/data/example_library.json)
